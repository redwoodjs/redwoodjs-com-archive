...
Execute scripts generated by [yarn redwood generate script <name>](/cli-commands#generate-script) to run one-off operations, long-running jobs, and utility scripts. 
...
See [this cookbook](/cookbook/) for an example of a background worker.
