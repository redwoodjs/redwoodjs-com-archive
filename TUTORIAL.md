...
First let's define the data structure for a post in the database. Open up `api/db/schema.prisma` and verify that the schema file has the following content
