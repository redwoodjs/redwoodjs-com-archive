...
const SECTIONS = [
  ...
  },
  {
    ...
    files: [
      ...
      { pageBreakAtHeadingDepth: [1], url: 'redwoodjs/redwood/packages/auth/README.md' },
      { pageBreakAtHeadingDepth: [1], url: './docs/assets.md' },
      {
        pageBreakAtHeadingDepth: [1],
        url: './docs/builds.md',
      },
  ...
  },
  {
    name: 'newsletter',
    files: [
      { pageBreakAtHeadingDepth: [1], url: './newsletter/wip-newsletter.md' },
    ],
  },
]
