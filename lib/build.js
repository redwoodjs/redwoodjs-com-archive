...
const SECTIONS = [
  ...
  },
  {
    ...
    files: [
      ...
      { pageBreakAtHeadingDepth: [1], url: 'redwoodjs/redwood/packages/auth/README.md', searchable: true, },
      { pageBreakAtHeadingDepth: [1], url: './docs/assets.md', searchable: true, },
      {
        pageBreakAtHeadingDepth: [1],
        url: './docs/builds.md',
        searchable: true,
      ...
      { pageBreakAtHeadingDepth: [1], url: 'redwoodjs/redwood/CONTRIBUTING.md', searchable: true, },
      {
        pageBreakAtHeadingDepth: [1],
  ...
  },
  {
    name: 'cookbook',
    files: [
      { pageBreakAtHeadingDepth: [1], file: './cookbook/Custom_Function.md', searchable: true, },
      { pageBreakAtHeadingDepth: [1], file: './cookbook/No_API.md', searchable: true, },
      { pageBreakAtHeadingDepth: [1], file: './cookbook/Third_Party_API.md', searchable: true, },
    ],
  },
  {
    name: 'reference',
  ...
  },
  {
    name: 'newsletter',
    files: [
      { pageBreakAtHeadingDepth: [1], url: './newsletter/wip-newsletter.md', searchable: false, },
    ],
  },
]
...
const main = async () => {
  ...
  await asyncForEach(SECTIONS, async (section) => {
    ...
    await asyncForEach(section.files, async (file, index) => {
      ...
      if (section.searchable) await publishSearch(markdown, section.name, { ...file, objectIDs })
      console.info('')
    })
