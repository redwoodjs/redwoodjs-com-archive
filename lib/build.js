...
const SECTIONS = [
  {
    ...
    files: [
      ...
      {
        pageBreakAtHeadingDepth: [1],
        url: './docs/projectConfiguration.md',
      },
      {
        pageBreakAtHeadingDepth: [1],
  ...
  },
  {
    ...
    files: [
      ...
      { pageBreakAtHeadingDepth: [1], file: './cookbook/Supabase_Auth.md', title: 'Supabase Auth' },
      { pageBreakAtHeadingDepth: [1], file: './cookbook/Third_Party_API.md' },
      { pageBreakAtHeadingDepth: [1], file: './cookbook/windows_setup.md' },
      { pageBreakAtHeadingDepth: [1], file: './cookbook/Sending_Emails.md' },
    ],
  },
  {
    name: 'videos',
